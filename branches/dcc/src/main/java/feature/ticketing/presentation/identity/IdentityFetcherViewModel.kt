...
import feature.ticketing.domain.data.identity.TicketingIdentityDocumentRemote
...
class IdentityFetcherViewModel @Inject constructor(
    ...
    fun initialize(ticketingCheckInParcelable: TicketingCheckInParcelable) {
        viewModelScope.launch {
            ...
            _identityFetcherResult.value = if (ticketingIdentityDocumentRemote != null) IdentityFetcherResult.Success(
                ticketingIdentityDocumentRemote
            ) else null
        }
    }
}