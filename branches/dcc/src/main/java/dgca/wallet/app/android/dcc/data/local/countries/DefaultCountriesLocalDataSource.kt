 ...
 *  ---license-end
 *
 *  Created by osarapulov on 7/26/21 11:57 AM
 */

package dgca.wallet.app.android.dcc.data.local.countries

import dgca.wallet.app.android.dcc.data.local.model.CountryLocal
...
class DefaultCountriesLocalDataSource(
    ...
    override fun getCountries(): Flow<List<String>> =
        countriesDao.getAll().map { list -> list.map { it.toCountry() } }
