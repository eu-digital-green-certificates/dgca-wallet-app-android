 ...
 *  ---license-end
 *
 *  Created by osarapulov on 4/20/22, 11:13 AM
 */

package feature.ticketing.domain.identity.validityserviceidentity
    ...
    fun shouldConvertValidationServiceIdentityResponseModel() {
        val validationServiceIdentityResponseIs: InputStream =
            javaClass.classLoader!!.getResourceAsStream(
                TICKETING_VALIDATION_SERVICE_IDENTITY_RESPONSE_FILE_NAME
            )
