...
class BookingSystemConsentFragment : BindingFragment<FragmentBookingSystemConsentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener(IdentityFetcherDialogFragment.IdentityFetcherRequestKey) { key, bundle ->
            ...
            if (identityDocument != null) {
                showAccessTokenFetcher(args.bookingSystemModel, identityDocument)
            } else {
    ...
    private fun showAccessTokenFetcher(bookingSystemModel: BookingSystemModel, identityDocument: IdentityDocument) {
        val action =
